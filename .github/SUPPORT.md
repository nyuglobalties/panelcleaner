# Getting help with panelcleaner

Thanks for using panelcleaner. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/panelcleaner/issues) to make sure the 
